...
public class FramedWallSignBlock extends WallSignBlock {
    public static final MapCodec<FramedWallSignBlock> CODEC = createCodec(settings -> new FramedWallSignBlock(WoodType.OAK, settings));

    public FramedWallSignBlock(WoodType woodType, Settings settings) {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        FramedSignBlock.refundCamo(world, pos);
