...
public class FramedLargePostBlock extends AbstractFramedEntityBlock implements Waterloggable {

    public static final MapCodec<FramedLargePostBlock> CODEC = createCodec(FramedLargePostBlock::new);
    ...
    public FramedLargePostBlock(Settings settings) {
        super(settings);
