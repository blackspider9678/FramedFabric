...
public class FramedSlabBlock extends SlabBlock implements BlockEntityProvider {
    ...
    public FramedSlabBlock(Settings settings) {
        ...
        // SlabBlock already has TYPE + WATERLOGGED in its default state
    ...
    // SlabBlock's getCodec signature can be annoying across versions.
    // This cast keeps it happy on 1.21.11 even if the supertype uses MapCodec<SlabBlock>.
    @Override
